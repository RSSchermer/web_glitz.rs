...
impl <C1, C2, F, Ec> OrElse<C1, C2, F, Ec> where C1: GpuTask<Ec>, C2: GpuTask<Ec, Output=C1::Output>, F: FnOnce(C1::Error) -> C2 {
...
impl <C1, C2, F, Ec> GpuTask<Ec> for OrElse<C1, C2, F, Ec> where C1: GpuTask<Ec>, C2: GpuTask<Ec, Output=C1::Output>, F: FnOnce(C1::Error) -> C2 {
