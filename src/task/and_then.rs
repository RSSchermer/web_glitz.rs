...
impl <C1, C2, F, Ec> AndThen<C1, C2, F, Ec> where C1: GpuTask<Ec>, C2: GpuTask<Ec, Error=C1::Error>, F: FnOnce(C1::Output) -> C2 {
...
impl <C1, C2, F, Ec> GpuTask<Ec> for AndThen<C1, C2, F, Ec> where C1: GpuTask<Ec>, C2: GpuTask<Ec, Error=C1::Error>, F: FnOnce(C1::Output) -> C2 {
