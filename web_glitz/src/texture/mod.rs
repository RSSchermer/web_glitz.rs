...
pub use self::texture_2d::{
    Texture2DHandle, Texture2DLevel, Texture2DLevelSubImage, Texture2DLevels, Texture2DLevelsIter,
    Texture2DUploadTask,
};

pub(crate) mod texture_2d_array;
pub use self::texture_2d_array::{
    Texture2DArrayHandle, Texture2DArrayLevel, Texture2DArrayLevelLayer,
...
pub use self::texture_3d::{
    Texture3DHandle, Texture3DLevel, Texture3DLevelLayer, Texture3DLevelLayerSubImage,
